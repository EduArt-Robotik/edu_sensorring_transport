...
constexpr std::uint8_t PARAMETER_CONFIG_SET_ITERATIONS      = 0x11;
...
constexpr std::uint8_t PARAMETER_CONFIG_GET_ITERATIONS      = PARAMETER_CONFIG_SET_ITERATIONS | PARAMETER_GETTER_BYTE;
